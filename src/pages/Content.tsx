  ...
  React.useEffect(() => {
    contentItems.forEach((item) => {
      if (
        ...
        (item.type === 'music-video' || item.type === 'movie' || item.type === 'audio-music')
      ) {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div>
          ...
          {contentItems.length > 0 && (
            <div className="mb-6 glass-effect p-4 rounded-xl space-y-4">
              <div>
            ...
            <div className="space-y-4">
              {filteredAndSortedContent.map((item) => {
                ...
                return (
                  <div
                    key={item.id}
                    className="glass-effect p-4 rounded-xl hover:bg-white/5 transition-colors"
                  >
